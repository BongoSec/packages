# Bongosec Virtual Machine

In this repository, you can find the necessary tools to build your own OVA file with all Bongosec components installed.

## Building OVA file:

Please, visit the following link for the full OVA building documentation: [Generate Bongosec virtual machine.](https://documentation.bongosec.com/current/development/packaging/generate-ova.html)
...
BONGOSEC Copyright (C) 2015 Bongosec Inc.  (License GPLv2)
