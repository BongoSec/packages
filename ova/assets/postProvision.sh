...
find /var/log/bongosec-indexer -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
find /var/log/filebeat -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
find /usr/share/bongosec-dashboard/data/bongosec/logs -type f -execdir sh -c 'cat /dev/null > "$1"' _ {} \;
