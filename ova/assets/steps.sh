...
systemConfig() {
  ...
  mv ${CUSTOM_PATH}/grub/bongosec.png /boot/grub2/
  ...
  # Update Bongosec indexer jvm heap
  ...
  # Change root password (root:bongosec)
  ...
  bash ${CUSTOM_PATH}/messages.sh ${DEBUG} ${BONGOSEC_VERSION} ${SYSTEM_USER}
