# Bongosec RPM packages

In this repository, you can find the necessary tools to build a Bongosec package for RPM based OS.

## Building RPM packages

Please, visit the following link for the full RPM packages building documentation: [Creating Bongosec RPM packages.](https://documentation.bongosec.com/current/development/packaging/generate-rpm-package.html)
