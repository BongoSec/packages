# Bongosec DEB packages

In this repository, you can find the necessary tools to build a Bongosec package for Debian based OS.

## Building DEB packages

Please, visit the following link for the full DEB packages building documentation: [Generate Bongosec Debian packages.](https://documentation.bongosec.com/current/development/packaging/generate-deb-package.html)
