#!/bin/bash
FILES_OLD="/usr/share/bongosec-indexer/plugins/opensearch-security/securityconfig"
FILES_NEW="/etc/bongosec-indexer/opensearch-security"
declare -A files_old
declare -A files_new
PACKAGE_NAME="${1}"
...
# Checks the version of Bongosec with 4.3 version, where path is different.
