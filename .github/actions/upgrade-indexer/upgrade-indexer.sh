...
echo "Installing old version of Bongosec indexer..."
if [ ${sys_type} == "deb" ]; then
    apt-get -y install bongosec-indexer
elif [ ${sys_type} == "rpm" ]; then
    add_production_repository
    yum -y install bongosec-indexer
else
...
echo "Installing new version of Bongosec indexer..."
if [ ${sys_type} == "deb" ]; then
