# Bongosec Windows packages

In this repository, you can find the necessary tools to build a Bongosec msi package for Windows.

## Building Windows packages

Please, visit the following link for the full Windows packages building documentation: [Generate Bongosec Windows packages.](https://documentation.bongosec.com/current/development/packaging/generate-windows-package.html)
