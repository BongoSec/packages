...
clean() {
    ...
    # Clean the files
    rm -rf ${DOCKERFILE_PATH}/{*.sh,*.tar.gz,bongosec-*} ${SOURCES_DIRECTORY}
...
help() {
    ...
    echo "    --packages-branch <branch>    [Required] Select Git branch or tag from packages repository. e.g ${PACKAGES_BRANCH}"
