...
test-ASSERT-FAIL-02-checks_names-indexer-bongosec-equals() {
    load-checks_names
    indxname="node1"
    winame="node1"
    checks_names
...
test-ASSERT-FAIL-03-checks_names-dashboard-bongosec-equals() {
    load-checks_names
    dashname="node1"
    winame="node1"
    checks_names
...
test-ASSERT-FAIL-04-checks_names-bongosec-node-name-not-in-config() {
    load-checks_names
    winame="node1"
    server_node_names=(bongosec node10)
    @mock echo ${server_node_names[@]} === @out bongosec node10
...
test-08-checks_names-all-correct-installing-bongosec() {
    load-checks_names
    indxname="indexer1"
    dashname="dashboard1"
    winame="bongosec1"
...
test-ASSERT-FAIL-18-checks_arguments-uninstall-and-bongosec() {
    load-checks_arguments
    uninstall=1
    bongosec=1
    checks_arguments
...
test-ASSERT-FAIL-22-checks_arguments-install-AIO-and-bongosec () {
    load-checks_arguments
    AIO=1
    bongosec=1
    checks_arguments
...
test-ASSERT-FAIL-24-checks_arguments-install-AIO-bongosec-installed-no-overwrite() {
    load-checks_arguments
    AIO=1
...
test-ASSERT-FAIL-25-checks_arguments-install-AIO-bongosec-files-no-overwrite() {
    load-checks_arguments
    AIO=1
...
test-30-checks_arguments-install-AIO-bongosec-installed-overwrite() {
    load-checks_arguments
    AIO=1
    bongosec_installed=1
    overwrite=1
...
test-30-checks_arguments-install-AIO-bongosec-installed-overwrite-assert() {
    installCommon_rollBack
}

test-31-checks_arguments-install-AIO-bongosec-files-overwrite() {
    load-checks_arguments
    AIO=1
    bongosec_remaining_files=1
    overwrite=1
...
test-31-checks_arguments-install-AIO-bongosec-files-overwrite-assert() {
    installCommon_rollBack
}
...
test-ASSERT-FAIL-40-checks_arguments-install-bongosec-already-installed-no-overwrite() {
    load-checks_arguments
    bongosec=1
    bongosec_installed=1
    overwrite=
...
test-ASSERT-FAIL-41-checks_arguments-install-bongosec-remaining-files-no-overwrite() {
    load-checks_arguments
    bongosec=1
    bongosec_remaining_files=1
    overwrite=
...
test-42-checks_arguments-install-bongosec-already-installed-overwrite() {
    load-checks_arguments
    bongosec=1
    bongosec_installed=1
    overwrite=1
...
test-42-checks_arguments-install-bongosec-already-installed-overwrite-assert() {
    installCommon_rollBack
}

test-43-checks_arguments-install-bongosec-remaining-files-overwrite() {
    load-checks_arguments
    bongosec=1
    bongosec_remaining_files=1
    overwrite=1
...
test-43-checks_arguments-install-bongosec-remaining-files-overwrite-assert() {
    installCommon_rollBack
}

test-ASSERT-FAIL-44-checks_arguments-install-bongosec-filebeat-already-installed-no-overwrite() {
    load-checks_arguments
    bongosec=1
...
test-ASSERT-FAIL-45-checks_arguments-install-bongosec-filebeat-remaining-files-no-overwrite() {
    load-checks_arguments
    bongosec=1
...
test-46-checks_arguments-install-bongosec-filebeat-already-installed-overwrite() {
    load-checks_arguments
    bongosec=1
    filebeat_installed=1
    overwrite=1
...
test-46-checks_arguments-install-bongosec-filebeat-already-installed-overwrite-assert() {
    installCommon_rollBack
}

test-47-checks_arguments-install-bongosec-filebeat-remaining-files-overwrite() {
    load-checks_arguments
    bongosec=1
    filebeat_remaining_files=1
    overwrite=1
...
test-47-checks_arguments-install-bongosec-filebeat-remaining-files-overwrite-assert() {
    installCommon_rollBack
}
...
test-ASSERT-FAIL-62-checks_health-bongosec-1-core-1700-ram() {
    load-checks_health
    cores=1
    ram_gb=1700
    bongosec=1
...
test-ASSERT-FAIL-63-checks_health-bongosec-2-cores-1000-ram() {
    load-checks_health
    cores=2
    ram_gb=1000
    bongosec=1
...
test-64-checks_health-bongosec-2-cores-1700-ram() {
    load-checks_health
    cores=2
    ram_gb=1700
    bongosec=1
...
test-ASSERT-FAIL-68-checks_previousCertificate-winame-not-in-tar_file() {
    ...
    @mock tar -tf tarfile.tar
    winame="bongosec1"
    @mockfalse grep -q bongosec1.pem
    @mockfalse grep -q bongosec1-key.pem
    checks_previousCertificate
    @rm /tmp/tarfile.tar
}
...
test-69-checks_previousCertificate-all-correct() {
    ...
    winame="bongosec1"
    @mocktrue grep -q bongosec1.pem
    @mocktrue grep -q bongosec1-key.pem
    dashname="dashboard1"
