...
function load-passwords-readFileUsers() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-readFileUsers
}
...
function load-passwords-changePassword() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-changePassword
}
...
test-05-passwords-changePassword-changeall-all-users-all-installed() {
    ...
    hashes=( "11" "22")
    @mkdir -p /usr/share/bongosec-indexer/backup/
    @touch /usr/share/bongosec-indexer/backup/internal_users.yml
    @mkdir -p /etc/filebeat
    @touch /etc/filebeat/filebeat.yml
    @mkdir -p /etc/kibana
    @touch /etc/kibana/kibana.yml
    @mock grep "password:" /etc/filebeat/filebeat.yml === @out "bongosecpasswordold"
    ...
    @rm /usr/share/bongosec-indexer/backup/internal_users.yml
...
test-05-passwords-changePassword-changeall-all-users-all-installed-assert() {
    awk -v new=11 'prev=="kibanaserver:"{sub(/\042.*/,""); $0=$0 new} {prev=$1} 1' /usr/share/bongosec-indexer/backup/internal_users.yml
    mv -f internal_users.yml_tmp /usr/share/bongosec-indexer/backup/internal_users.yml
    awk -v new=22 'prev=="admin:"{sub(/\042.*/,""); $0=$0 new} {prev=$1} 1' /usr/share/bongosec-indexer/backup/internal_users.yml
    mv -f internal_users.yml_tmp /usr/share/bongosec-indexer/backup/internal_users.yml
...
test-08-passwords-changePassword-nuser-admin-filebeat-installed-assert() {
    awk -v new=11 'prev=="admin:"{sub(/\042.*/,""); $0=$0 new} {prev=$1} 1' /usr/share/bongosec-indexer/backup/internal_users.yml
    mv -f internal_users.yml_tmp /usr/share/bongosec-indexer/backup/internal_users.yml
    echo "admin_configuration_string"
    recommon_startService "filebeat"
}
...
function load-passwords-checkInstalledPass() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-checkInstalledPass
}
...
test-11-passwords-checkInstalledPass-all-installed-yum() {
    ...
    @mock grep opendistroforelasticsearch === @echo opendistroforelasticsearch.x86_64 1.13.2-1 @bongosec
    @mock grep -v kibana
    ...
    @mock grep "plugins.security.ssl.transport.pemtrustedcas_filepath: " /etc/bongosec-indexer/opensearch.yml === @out "pem_path"
...
test-11-passwords-checkInstalledPass-all-installed-yum-assert() {
    ...
    @echo "opendistroforelasticsearch.x86_64 1.13.2-1 @bongosec"
...
function load-passwords-checkUser() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-checkUser
}
...
function load-passwords-generatePasswordFile() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-generatePasswordFile
}
...
function load-passwords-getNetworkHost() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-getNetworkHost
}

test-19-passwords-getNetworkHost() {
    load-passwords-getNetworkHost
    @mock grep -hr "network.host:" /etc/bongosec-indexer/opensearch.yml === @out "network.host: 1.1.1.1"
...
test-20-passwords-getNetworkHost-interface() {
    load-passwords-getNetworkHost
    @mock grep -hr "network.host:" /etc/bongosec-indexer/opensearch.yml === @out "network.host: _wlps01_"
...
test-21-passwords-getNetworkHost-localhost() {
    load-passwords-getNetworkHost
    @mock grep -hr "network.host:" /etc/bongosec-indexer/opensearch.yml === @out "network.host: 0.0.0.0"
    passwords-getNetworkHost
    @echo ${IP}
}
...
function load-passwords-readAdmincerts() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-readAdmincerts
}

test-ASSERT-FAIL-22-passwords-readAdmincerts-no-admin.pem() {
    load-passwords-readAdmincerts
    if [[ -f /etc/bongosec-indexer/certs/admin.pem ]]; then
        @rm -f /etc/bongosec-indexer/certs/admin.pem
    fi
    passwords-readAdmincerts
}
...
test-ASSERT-FAIL-23-passwords-readAdmincerts-no-admin_key.pem() {
    load-passwords-readAdmincerts
    @mkdir -p /etc/bongosec-indexer/certs
    if [[ ! -f /etc/bongosec-indexer/certs/admin.pem ]]; then
        @touch /etc/bongosec-indexer/certs/admin.pem
    fi
    if [[ -f /etc/bongosec-indexer/certs/admin-key.pem ]]; then
        @rm -f /etc/bongosec-indexer/certs/admin-key.pem
    fi

    if [[ -f /etc/bongosec-indexer/certs/admin.key ]]; then
        @rm -f /etc/bongosec-indexer/certs/admin.key
    fi
    passwords-readAdmincerts
    @rm /etc/bongosec-indexer/certs/admin.pem
    @rmdir /etc/bongosec-indexer/certs
}
...
test-24-passwords-readAdmincerts-all-correct-admin_key.pem() {
    ...
    if [[ ! -f /etc/bongosec-indexer/certs/admin-key.pem ]]; then
        @touch /etc/bongosec-indexer/certs/admin-key.pem
    fi
    ...
    passwords-readAdmincerts
    @rm /etc/bongosec-indexer/certs/admin.pem
    @rm /etc/bongosec-indexer/certs/admin-key.pem
    @rmdir /etc/bongosec-indexer/certs
    @echo $adminpem
    @echo $adminkey
}
...
test-24-passwords-readAdmincerts-all-correct-admin_key.pem-assert() {
    @echo "/etc/bongosec-indexer/certs/admin.pem"
    @echo "/etc/bongosec-indexer/certs/admin-key.pem"
}
...
test-25-passwords-readAdmincerts-all-correct-admin.key() {
    ...
    if [[ ! -f /etc/bongosec-indexer/certs/admin.key ]]; then
        @touch /etc/bongosec-indexer/certs/admin.key
    fi
    passwords-readAdmincerts
    @rm /etc/bongosec-indexer/certs/admin.pem
    @rm /etc/bongosec-indexer/certs/admin.key
    @rmdir /etc/bongosec-indexer/certs
    @echo $adminpem
    @echo $adminkey
}
...
test-25-passwords-readAdmincerts-all-correct-admin.key-assert() {
    @echo "/etc/bongosec-indexer/certs/admin.pem"
    @echo "/etc/bongosec-indexer/certs/admin.key"
}

function load-passwords-readUsers() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-readUsers
}

test-26-passwords-readUsers() {
    load-passwords-readUsers
    @mock grep -B 1 hash: /etc/bongosec-indexer/opensearch-security/internal_users.yml === @out
...
function load-recommon_startService() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" recommon_startService
}
...
test-ASSERT-FAIL-28-recommon_startService-no-service-manager() {
    ...
    recommon_startService bongosec-manager
}
...
test-29-recommon_startService-systemd-assert() {
    ...
    systemctl restart bongosec-manager.service
}
...
test-30-recommon_startService-systemd-error() {
    ...
    @mocktrue grep -E -q "^\ *1\ .*systemd$"
    @mockfalse grep -E -q "^\ *1\ .*init$"
    @mockfalse systemctl restart bongosec-manager.service
...
function load-passwords-generateHash() {
    @load_function "${base_dir}/bongosec-passwords-tool.sh" passwords-generateHash
}
...
test-34-passwords-generateHash-changeall() {
    ...
    @mock bash /usr/share/bongosec-indexer/plugins/opensearch-security/tools/hash.sh -p "kibanaserverpassword" === @out "11111111"
    @mock bash /usr/share/bongosec-indexer/plugins/opensearch-security/tools/hash.sh -p "adminpassword" === @out "22222222"
...
test-ASSERT-FAIL-35-passwords-generateHash-changeall-error() {
    ...
    @mock bash /usr/share/bongosec-indexer/plugins/opensearch-security/tools/hash.sh -p "kibanaserverpassword" === @out "11111111"
    @mockfalse bash /usr/share/bongosec-indexer/plugins/opensearch-security/tools/hash.sh -p "adminpassword"
    passwords-generateHash
    @echo ${hashes[@]}
}
...
test-ASSERT-FAIL-37-passwords-generateHash-nuser-error() {
    ...
    changeall=
    @mockfalse grep -v WARNING
    @mockfalse bash /usr/share/bongosec-indexer/plugins/opensearch-security/tools/hash.sh -p "kibanaserverpassword"
    passwords-generateHash
}