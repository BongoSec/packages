...
# Program to build the Bongosec App for Splunk
...
BRANCH_TAG=""
SPLUNK_VERSION=""
CONTAINER_NAME="bongosec-splunk-app-builder"
OUTDIR="${CURRENT_PATH}/output"
CHECKSUMDIR=""
REVISION=""
REPOSITORY="bongosec-splunk"
...
build_package() {
    ...
    docker run -t --rm -v ${OUTDIR}:/bongosec_splunk_app:Z \
