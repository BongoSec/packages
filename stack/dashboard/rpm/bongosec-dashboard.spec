...
%global DASHBOARD_FILE bongosec-dashboard-base-%{version}-%{release}-linux-x64.tar.xz
...
cp bongosec-dashboard-base/etc/node.options %{buildroot}%{CONFIG_DIR}
cp bongosec-dashboard-base/etc/opensearch_dashboards.yml %{buildroot}%{CONFIG_DIR}
cp bongosec-dashboard-base/VERSION %{buildroot}%{INSTALL_DIR}
...
if [ "%{version}" = "99.99.0" ];then
    runuser %{USER} --shell="/bin/bash" --command="%{buildroot}%{INSTALL_DIR}/bin/opensearch-dashboards-plugin install https://packages-dev.bongosec.com/futures/ui/dashboard/bongosec-99.99.0-%{release}.zip"
    runuser %{USER} --shell="/bin/bash" --command="%{buildroot}%{INSTALL_DIR}/bin/opensearch-dashboards-plugin install https://packages-dev.bongosec.com/futures/ui/dashboard/bongosecCheckUpdates-99.99.0-%{release}.zip"
    runuser %{USER} --shell="/bin/bash" --command="%{buildroot}%{INSTALL_DIR}/bin/opensearch-dashboards-plugin install https://packages-dev.bongosec.com/futures/ui/dashboard/bongosecCore-99.99.0-%{release}.zip"
else
...
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCheckUpdates/ -exec chown %{USER}:%{GROUP} {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCheckUpdates/ -type f -perm 644 -exec chmod 640 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCheckUpdates/ -type f -perm 755 -exec chmod 750 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCheckUpdates/ -type d -exec chmod 750 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCheckUpdates/ -type f -perm 744 -exec chmod 740 {} \;

find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCore/ -exec chown %{USER}:%{GROUP} {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCore/ -type f -perm 644 -exec chmod 640 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCore/ -type f -perm 755 -exec chmod 750 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCore/ -type d -exec chmod 750 {} \;
find %{buildroot}%{INSTALL_DIR}/plugins/bongosecCore/ -type f -perm 744 -exec chmod 740 {} \;
# -----------------------------------------------------------------------------
...
%attr(750, %{USER}, %{GROUP}) "/etc/default/bongosec-dashboard"
